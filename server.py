...
# Load team data from external JSON
...
async def get_predictions(date: Optional[str] = None):
    ...
    try:
        ...
        predictions = _generate_predictions_for_date(date)
        if not predictions:
...
async def generate_predictions():
    ...
    try:
        ...
        predictions = _generate_predictions_for_date(today)
        
        if predictions:
            utils_data.save_json(predictions, utils_data.get_prediction_file_path(today))
